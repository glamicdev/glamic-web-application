          ...
          <div className="p-3 border-b border-gray-100 dark:border-gray-800">
            ...
            {canCopyTo.map((targetDay) => (
              <label key={targetDay.day} className="flex items-center gap-2 py-1">
                ...
                />
                <span className="text-sm text-gray-900 dark:text-white">{targetDay.day}</span>
              </label>
            ))}
          </div>
      ...
      >
        {currentSchedule.workDays.map((day, index) => (
          <DayCard
            ...
            canCopyTo={currentSchedule.workDays.filter((d, i) => i !== index && (!d.enabled || d.startTime !== day.startTime || d.endTime !== day.endTime))}
