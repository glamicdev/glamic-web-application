...
export default function AppDownload() {
  ...
  const qrCodeUrl =
    "https://groomee-storage.s3.us-east-2.amazonaws.com/glamic-qr-code-website-download.png";
    ...
    <Layout maxWidth="md">
      <div className="text-center mb-8">
        ...
        <Text className="max-w-md mx-auto">
          Experience the future of beauty business management on your mobile
          device. Our web experience is coming soon!
        </Text>
      </div>
