    ...
    <Layout maxWidth="md">
      <div className="text-center mb-8">
        ...
        <Text className="max-w-2xl mx-auto">
          Add your profile photo to join Glamic's marketplace and unlock the opportunity 
      ...
      >
        ...
        <div className={`p-6 rounded-2xl ${profilePhoto ? 'bg-primary-gold/10' : 'bg-gray-50'}`}>
