...
export default function WebsiteSubheadline() {
  ...
  const [subheadline, setSubheadline] = useState(
    "Personalized beauty services delivered with expertise and care"
  );
    ...
    <motion.div {...fadeIn} className="w-full max-w-xl mx-auto">
      <div className="text-center mb-8">
        ...
        <Text className="max-w-md mx-auto">
          Your subheadline provides additional context and supports your main
          message. Use it to highlight key benefits or unique selling points.
        </Text>
      </div>
          ...
          <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border-2 border-gray-200 dark:border-white/10">
            ...
            <div className="space-y-4 text-gray-600">
              <div className="text-sm text-gray-700 dark:text-gray-300">
                "Bringing out your natural beauty for weddings, events, and
                photoshoots"
              </div>
              <div className="text-sm text-gray-700 dark:text-gray-300">
                "Creating stunning looks that make you feel confident and
                beautiful"
              </div>
              <div className="text-sm text-gray-700 dark:text-gray-300">
                "Personalized beauty services delivered with expertise and care"
