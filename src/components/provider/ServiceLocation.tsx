...
import { staggerChildren, slideIn } from "../../ui/animations";
        ...
        <div className="text-left">
          <h3
            className={`text-lg font-semibold mb-1 ${
              selected ? "text-primary-gold" : "text-gray-900 dark:text-white"
            }`}
          >
            {title}
          </h3>
  ...
  const setLocationType = (type: "mobile" | "studio" | "both") => {
    ...
    dispatch({
      ...
      payload: {
        ...
        type: newType as "mobile" | "studio" | "both" | "",
      },
    });
  };
  ...
  return (
    <Layout maxWidth="lg">
      ...
      <Text className="text-center mb-8 max-w-xl mx-auto dark:text-gray-300">
        Select where you'd like to provide your services. You can choose to be
        mobile, work from a studio, or both.
      </Text>
      ...
      <motion.div {...staggerChildren} className="grid gap-4 mb-12">
        <LocationOption
          ...
          description="Travel to your clients' location"
        ...
        <LocationOption
          ...
          description="Clients come to your location"
      ...
      <motion.div
        ...
        animate={{
          opacity: state.serviceLocation.type ? 1 : 0,
          y: state.serviceLocation.type ? 0 : 20,
        }}
