...
export default function MobileSettings() {
  ...
  return (
    <motion.div {...fadeIn} className="w-full max-w-lg mx-auto px-4">
      ...
      <motion.div variants={staggerChildren} className="space-y-8">
        <motion.div variants={fadeIn} className="text-center">
          <Text className="text-xl font-medium mb-4">
            Your mobile service area is set to cover a{" "}
            {state.serviceLocation.mobileRadius} Km radius
          </Text>
        </motion.div>

        <motion.div variants={fadeIn} className="text-center">
          <Text className="text-xl font-medium mb-4">
            Travel fee of ${state.serviceLocation.travelFeePerKm} per Km with a
            minimum fee of $15
          </Text>
        </motion.div>
        ...
        <motion.div variants={fadeIn} className="text-center">
          <Text className="text-xl font-medium">
            A minimum spend requirement of ${state.serviceLocation.minimumSpend}{" "}
            for mobile bookings.
          </Text>
        </motion.div>
