    ...
    <Layout maxWidth="md">
      <div className="text-center mb-8">
        ...
        <Text className="max-w-md mx-auto">
          Write a compelling bio that showcases your expertise and connects with
          potential clients.
        </Text>
      </div>
      ...
      <motion.div className="space-y-6">
        <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border-2 border-gray-200 dark:border-white/10">
          ...
          <Text className="text-sm text-gray-600 dark:text-gray-300 italic">
            "With over 8 years of experience in professional makeup artistry, I
            specialize in creating stunning looks for weddings, special events,
            and photo shoots. My approach combines classic techniques with
            current trends to enhance your natural beauty. Whether you're
            planning your dream wedding or preparing for an important photo
            session, I'm here to help you look and feel your absolute best."
          </Text>
        </div>
        {/* Bio Input */}
        <div className="space-y-2">
          <div className="relative">
            <textarea
              ...
              className="w-full h-64 px-6 py-4 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:border-primary-gold focus:ring-0 text-lg resize-none bg-white dark:bg-primary-navy/50 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
              rows={8}
              maxLength={MAX_CHARS}
            />
            <div
