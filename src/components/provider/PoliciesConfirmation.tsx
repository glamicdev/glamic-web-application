    ...
    <Layout maxWidth="2xl">
      <div className="text-center mb-8">
        ...
        >
          ...
          <span className="text-sm font-medium">Business Protection</span>
        </motion.div>

        <Heading>Policies & Waivers</Heading>
        <Text className="text-center mb-8 max-w-xl mx-auto">
          We've created comprehensive policies and waivers for your business, so
          you don't have to start from scratch. You can customize these to fit
          your needs.
        </Text>
      </div>
      ...
      >
        <StatCard
          ...
          value="10 Policies"
          label="Pre-written business policies"
        />

        <StatCard
          icon={<ScrollText className="w-5 h-5" />}
          value="7 Waivers"
          label="Ready-to-use protection agreements"
        />
      </motion.div>
