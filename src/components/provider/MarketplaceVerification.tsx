    ...
    <Layout maxWidth="md">
      <div className="text-center mb-8">
        ...
        <Text className="max-w-2xl mx-auto">
          Add your profile photo to join Glamic's marketplace and unlock the
          opportunity to become a verified seller with exclusive benefits.
        </Text>
      </div>
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <Requirement
            ...
            description="Get priority listing, higher visibility, and exclusive features. ID verification and background check required upon qualifying."
          />

          <Requirement
            icon={<BadgeCheck className="w-5 h-5" />}
            title="Verified Badge Requirements"
            description="Maintain a 4+ star rating for 6 months with regular bookings. Complete ID verification and background check when qualified."
          />
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border-2 border-gray-200 dark:border-white/10">
            <div className="flex items-start gap-3 mb-6">
              ...
              >
                Your profile photo is crucial for building trust with potential
                clients. Ensure your photo:
            ...
            <div className="flex items-start gap-3 mb-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
              ...
              <Text as="div" className="text-sm text-gray-600">
                For everyone's safety, we cooperate with local law enforcement
                and may share account information in the rare case of
        ...
        <div
          className={`p-6 rounded-2xl ${
            profilePhoto ? "bg-primary-gold/10" : "bg-gray-50"
          }`}
        >
