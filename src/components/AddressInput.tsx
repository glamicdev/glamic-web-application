  ...
  return (
    <Layout maxWidth="lg">
      ...
      <Text className="text-center mb-12 max-w-xl mx-auto">
        Add your studio location or starting point for mobile services. This helps us 
      ...
      <motion.div {...staggerChildren} className="space-y-4">
        ...
        <div className="mt-6">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-gray-700 dark:text-gray-300">Billing address is the same as base address</span>
          </label>
        </div>
